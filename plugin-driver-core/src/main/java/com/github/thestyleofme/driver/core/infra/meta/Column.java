...
public class Column extends BaseInfo implements Serializable, Cloneable {
    ...
    public Column(ResultSet rs) {
        ...
        this.columnName = properties.getString("COLUMN_NAME");
        this.dataType = properties.getInt("DATA_TYPE");
        this.typeName = properties.getString("TYPE_NAME");
        this.columnSize = properties.getInt("COLUMN_SIZE");
        this.decimalDigits = properties.getInt("DECIMAL_DIGITS");
        this.numPrecRadix = properties.getInt("NUM_PREC_RADIX");
        this.nullable = properties.getInt("NULLABLE");
        this.remarks = properties.getString("REMARKS");
        this.columnDef = properties.getString("COLUMN_DEF");
        this.charOctetLength = properties.getString("CHAR_OCTET_LENGTH");
        this.ordinalPosition = properties.getInt("ORDINAL_POSITION");
        this.isNullable = properties.getString("IS_NULLABLE");
        this.sourceDataType = properties.getInt("SOURCE_DATA_TYPE");
        this.isGeneratedColumn = properties.getString("IS_GENERATEDCOLUMN");
        this.isAutoincrement = properties.getString("IS_AUTOINCREMENT");
    }

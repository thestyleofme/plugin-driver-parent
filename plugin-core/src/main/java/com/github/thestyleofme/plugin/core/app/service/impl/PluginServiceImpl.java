...
import com.github.thestyleofme.plugin.core.infra.mapper.PluginMapper;
import com.github.thestyleofme.plugin.core.infra.utils.Md5Util;
...
public class PluginServiceImpl extends ServiceImpl<PluginMapper, Plugin> implements PluginService {
    ...
    public PluginDTO update(PluginDTO dto, MultipartFile multipartFile) {
        ...
        if (!dto.getObjectVersionNumber().equals(oldPlugin.getObjectVersionNumber())) {
            throw new PluginException("please refresh and try again");
        }
        // 更新插件前置钩子

...
import com.github.thestyleofme.driver.emr.session.EmrDriverSessionFactory;
 ...
 * @since 1.0
 */
public class EmrDriverSessionTest {
    ...
    public void buildOracleSession() {
        ...
        EmrDriverSessionFactory hive3DriverSessionFactory = new EmrDriverSessionFactory();
        hive3DriverSessionFactory.setDataSource(dataSource);
        this.driverSession = hive3DriverSessionFactory.getDriverSession();
    }
    ...
    public void testTableQuery() {
        List<Map<String, Object>> tableQuery = driverSession.tableQuery("default", "randomdatageneration_d8973efc_out1_188");
    ...
    public void testSelect() {
        List<List<Map<String, Object>>> result = driverSession.executeAll("default", "select * from randomdatageneration_d8973efc_out1_188", true);
    ...
    */
    ...
    public void testTableMetaData() {
        Table table = driverSession.tableMetaData("default", "randomdatageneration_d8973efc_out1_188");
    ...
    public void tableMetaExtra() {
        Table table = driverSession.tableMetaExtra("default", "randomdatageneration_d8973efc_out1_188");
        System.out.println(table);
        assertTrue(Objects.nonNull(table));
    }
    ...
    public void columnMetaData() {
        List<Column> columns = driverSession.columnMetaData("cxk", "mysql_all_col");
    ...
    public void testShowCreateSql() {
        String showTableSql = driverSession.showCreateSql("default", "randomdatageneration_d8973efc_out1_188", ShowType.TABLE);
    ...
    @Test
    public void testURI(){
        String path  = "s3://hdsp-mail/warehouse/lshdsp.db/daily_report_string";

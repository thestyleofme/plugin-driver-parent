package com.github.thestyleofme.driver.emr.datasource;
 ...
 */
@Component
public class EmrDataSourceFunction implements DriverDataSourceFunction<PluginDatasourceVO, DataSource> {

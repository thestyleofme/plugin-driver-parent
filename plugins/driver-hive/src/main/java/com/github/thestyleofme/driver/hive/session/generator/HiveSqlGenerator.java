package com.github.thestyleofme.driver.hive.session.generator;
...
import com.github.thestyleofme.driver.hive.session.meta.HiveTable;
 ...
 * @since 1.0
 */
public class HiveSqlGenerator extends AbstractRdbmsSqlGenerator {
    ...
    private static class HiveSqlGeneratorHolder {
        private static final SqlGenerator INSTANCE = new HiveSqlGenerator();
    }

    public static SqlGenerator getInstance() {
        return HiveSqlGeneratorHolder.INSTANCE;
    }
   ...
   /*     String stored = tmp.getStored();
        ...
        switch (dataType) {
            ...
            default:
                throw new UnsupportedOperationException(
                        String.format("Hive generator unsupported data type:[%s],column:[%s]",
    ...
    public String dropColumn(Column column) {
        HiveColumn tmp = (HiveColumn) column;

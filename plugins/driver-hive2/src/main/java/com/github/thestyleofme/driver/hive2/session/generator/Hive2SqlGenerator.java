package com.github.thestyleofme.driver.hive2.session.generator;
...
import com.github.thestyleofme.driver.hive2.session.meta.Hive2Column;
import com.github.thestyleofme.driver.hive2.session.meta.Hive2Table;
 ...
 * @since 1.0
 */
public class Hive2SqlGenerator extends AbstractRdbmsSqlGenerator {
    ...
    private static class Hive2SqlGeneratorHolder {
        private static final SqlGenerator INSTANCE = new Hive2SqlGenerator();
    }
    ...
    public String createTable(Table table) {
        ...
        sql.append(String.format(CREATE_TABLE, schema, tableName)).append(LEFT_BRACKET).append(NEWLINE);
        ...
        sql.append(RIGHT_BRACKET).append(NEWLINE);
        // 是否分区 先注释
   ...
   /*     String stored = tmp.getStored();
        ...
        switch (dataType) {
            ...
            default:
                throw new UnsupportedOperationException(
                        String.format("Hive2 generator unsupported data type:[%s],column:[%s]",
    ...
    public String dropTable(Table table) {
        ...
        if (Boolean.TRUE.equals(isPartition)) {
            ...
            partitionColumns.forEach(c -> tmpEqual.append(String.format(PARTITION_EQUAL, c.getColumnName(), c.getColumnDef())));
    ...
    public String dropColumn(Column column) {
        Hive2Column tmp = (Hive2Column) column;

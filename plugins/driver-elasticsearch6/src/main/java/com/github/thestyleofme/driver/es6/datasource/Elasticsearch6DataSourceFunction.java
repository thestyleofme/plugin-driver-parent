package com.github.thestyleofme.driver.es6.datasource;
 ...
 */
@Component
public class Elasticsearch6DataSourceFunction implements DriverDataSourceFunction<PluginDatasourceVO, MutablePair<RestHighLevelClient, HttpExec>> {

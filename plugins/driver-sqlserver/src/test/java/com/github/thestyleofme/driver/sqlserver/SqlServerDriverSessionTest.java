...
import com.github.thestyleofme.driver.sqlserver.session.SqlServerDriverSessionFactory;
 ...
 * </p>
 *
 * @author lgl 2020/08/17 9:29
 * @since 1.0
 */
public class SqlServerDriverSessionTest {
    private DriverSession driverSession;

    @Before
    public void buildMysqlSession() {
        HikariDataSource dataSource = new HikariDataSource();
        dataSource.setJdbcUrl("jdbc:sqlserver://172.23.16.39:1433;DatabaseName=test");
        dataSource.setUsername("sa");
        dataSource.setPassword("wz980118..");
        dataSource.setDriverClassName(SQLServerDriver.class.getName());
        SqlServerDriverSessionFactory sqlServerDriverSessionFactory = new SqlServerDriverSessionFactory();
        sqlServerDriverSessionFactory.setDataSource(dataSource);
        this.driverSession = sqlServerDriverSessionFactory.getDriverSession();
    }
...
//        text.append(showCreateTableSql).append("\n");
        ...
        List<List<Map<String, Object>>> executeAll = driverSession.executeAll("test123", "select * from test1", true);

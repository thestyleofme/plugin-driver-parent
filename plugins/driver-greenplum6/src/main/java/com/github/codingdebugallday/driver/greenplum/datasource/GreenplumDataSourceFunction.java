package com.github.codingdebugallday.driver.greenplum.datasource;
...
@Slf4j
@Extension
public class GreenplumDataSourceFunction implements DriverDataSourceFunction<PluginDatasourceVO, DataSource> {

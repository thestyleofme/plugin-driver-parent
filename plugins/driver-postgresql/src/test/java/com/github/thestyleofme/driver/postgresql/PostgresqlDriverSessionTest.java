...
public class PostgresqlDriverSessionTest {
    ...
    public void testTablesNameAndDesc() {
        List<Table> tables = driverSession.tablesNameAndDesc("public");
...
//        assertFalse(CollectionUtils.isEmpty(foreignKeys));
    ...
    public void testExecutePageAll() {
        ...
        List<Page<Map<String, Object>>> pages = driverSession.executePageAll("plugin_test", "select * from xtau_view", PageRequest.of(2, 10));

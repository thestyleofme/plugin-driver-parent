package com.github.thestyleofme.driver.postgresql;
...
import com.github.thestyleofme.driver.postgresql.session.PostgresqlDriverSessionFactory;
 ...
 * @since 1.0
 */
public class PostgresqlSqlGeneratorTest {

    private final SqlGenerator sqlGenerator = PostgresqlSqlGenerator.getInstance();
    ...
    public void testUpdateComment(){
        List<Column> columns = driverSession.columnMetaData("plugin_test", "xtau_view");

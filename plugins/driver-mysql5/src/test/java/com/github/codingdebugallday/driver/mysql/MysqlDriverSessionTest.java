...
import com.github.codingdebugallday.driver.mysql.session.MysqlDriverSessionFactory;
...
public class MysqlDriverSessionTest {
    ...
    public void buildMysqlSession() {
        ...
        dataSource.setJdbcUrl("jdbc:mysql://172.23.16.63:23306/hdsp_core?useUnicode=true&characterEncoding=utf-8&useSSL=false");
        dataSource.setUsername("hdsp_dev");
        dataSource.setPassword("hdsp_dev123$%^");
        dataSource.setSchema("hdsp_core");

package com.github.thestyleofme.driver.redshift.generator;
 ...
 * @date 2020/8/7 16:55
 */
public class RedshiftSqlGenerator extends AbstractRdbmsSqlGenerator {
    //===============================================================================
    //  Table
    //===============================================================================
    /**
    ...
    private static class RedshiftSqlGeneratorHolder {

        private static final SqlGenerator INSTANCE = new RedshiftSqlGenerator();
    }

    public static SqlGenerator getInstance() {
        return RedshiftSqlGeneratorHolder.INSTANCE;
    }
        ...
        switch (dataType) {
            ...
            default:
                throw new UnsupportedOperationException(
                        String.format("RedShiftSql generator unsupported data type:[%s],column:[%s]",

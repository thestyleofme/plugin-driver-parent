...
CREATE TABLE `plugin`  (
  ...
  `plugin_big_class` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '插件大类',
  `plugin_small_class` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '插件小类',
